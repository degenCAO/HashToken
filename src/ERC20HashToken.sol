...
contract HashToken is ERC20 {
    ...
    By defalt it's 1 in  1 000 000(modern CPU generate 100 000 to 1 000 000 hashes per second)
    */
    constructor(
        string memory name,
        ...
        TIMESTAMP = block.timestamp;
                if (difficultyAdjustment != 0) {DIFFICULTY = type.uint256/difficultyAdjustment}
        else DIFFICULTY = type.uint256/1e6;
